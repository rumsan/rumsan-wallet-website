			...
			<>
				<footer className="footer-area" id="footer">
						...
						<div className="row justify-content-center">
							<div className="col-lg-4 col-sm-6">
								<div className="single-footer-widget">
									...
									<p>
										Rumsan is a blockchain-focused digital innovation company. We envision creating societal impact
										through frontier technologies. We support and invest in promising ideas and innovators to make a
										bigger impact.
									</p>
									...
									<div className="company-logo">
										...
										<Link href="https://askbhunte.com/">
											<a target="_blank">
												<img src="https://assets.rumsan.com/askbhunte/assets/askbhunte-sq.png" alt="" />
											</a>
										</Link>
										<Link href="https://agriclear.io/">
											<a target="_blank">
												<img src="https://assets.rumsan.com/esatya/agriclear-sq.png" alt="" />
											</a>
										</Link>
										<Link href="https://esatya.io/">
											<a target="_blank">
												<img src="https://assets.rumsan.com/esatya/esatya-square-logo-500x500.png" alt="" />
											</a>
										</Link>
										<Link href="https://lonetreenepal.com/">
											<a target="_blank">
												<img src="https://assets.rumsan.com/rumsan-test/lonetree-100x100.png" alt="" />
											</a>
										</Link>
									</div>
								</div>
					...
					<div className="copyright-area">
						<div className="container">
							<p>
								Copyright &copy; {currentYear} Rahat. A part of{' '}
